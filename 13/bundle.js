...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: constants, SortType, UserAction, UpdateType, FilterType, ExstraFilmsList, NetworksList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExstraFilmsList", function() { return ExstraFilmsList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NetworksList", function() { return NetworksList; });
const constants = {
  ESC: `Escape`,
};
...
/* harmony import */ var _presenter_films_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/films-list */ "./src/presenter/films-list.js");
/* harmony import */ var _presenter_filters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./presenter/filters */ "./src/presenter/filters.js");
/* harmony import */ var _view_footer_statistics__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/footer-statistics */ "./src/view/footer-statistics.js");
/* harmony import */ var _model_films__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/films */ "./src/model/films.js");
/* harmony import */ var _model_filters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/filters */ "./src/model/filters.js");
...
const api = new _api_api__WEBPACK_IMPORTED_MODULE_8__["default"](_const__WEBPACK_IMPORTED_MODULE_7__["NetworksList"].END_POINT, _const__WEBPACK_IMPORTED_MODULE_7__["NetworksList"].AUTHORIZATION);

Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(headerElement, new _view_menu__WEBPACK_IMPORTED_MODULE_0__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);

const filtersModel = new _model_filters__WEBPACK_IMPORTED_MODULE_5__["default"]();
const filmModel = new _model_films__WEBPACK_IMPORTED_MODULE_4__["default"]();

api.getFilms()
  .then((films) => {
    filmModel.setFilms(_const__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT, films);
  })
  .catch(() => {
    filmModel.setFilms(_const__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].INIT, []);
  });

// presenters
const filtersPresenter = new _presenter_filters__WEBPACK_IMPORTED_MODULE_2__["default"](mainElement, filtersModel, filmModel);
filtersPresenter.init();
const filmsList = new _presenter_films_list__WEBPACK_IMPORTED_MODULE_1__["default"](mainElement, filmModel, filtersModel, api);
filmsList.init();
...
/* harmony import */ var _view_comment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/comment */ "./src/view/comment.js");
/* harmony import */ var _view_comments_count__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/comments-count */ "./src/view/comments-count.js");
...
class Film {
  constructor(container, changeData, prevDetails) {
    ...
    this._commentsModel = new _model_comments__WEBPACK_IMPORTED_MODULE_4__["default"]();
  ...
  init(film) {
    this._film = film;
    this._api = new _api_api__WEBPACK_IMPORTED_MODULE_7__["default"](_const__WEBPACK_IMPORTED_MODULE_6__["NetworksList"].END_POINT, _const__WEBPACK_IMPORTED_MODULE_6__["NetworksList"].AUTHORIZATION);
    ...
    if (prevFilmComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._filmCardComponent, _utils_render__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      return;
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._filmCardComponent, prevFilmComponent);
    }
  ...
  _renderDetails() {
    ...
    if (this._detailsComponent) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._detailsComponent, prevDetailsComponent);
    }
    if (prevDetailsComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["remove"])(prevDetailsComponent);
    }
  }

  _renderComments() {
    this._commentsCountComponent = new _view_comments_count__WEBPACK_IMPORTED_MODULE_3__["default"](this._comments.length);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(this._detailsComponent.commentWrap, this._commentsCountComponent, _utils_render__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].AFTERBEGIN);
    this._comments.forEach((comment) => {
      const newComment = new _view_comment__WEBPACK_IMPORTED_MODULE_2__["default"](comment);
      this._commentsComponents.push(newComment);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(this._detailsComponent.commentList, newComment, _utils_render__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  ...
  _onDetailsEscKeydown(evt) {
    if (evt.key === _const__WEBPACK_IMPORTED_MODULE_6__["constants"].ESC) {
      this._closeDetails();
    }
  }
  ...
  _onAddWatchedClick() {
    this._changeData(
        _const__WEBPACK_IMPORTED_MODULE_6__["UserAction"].UPDATE_FILM,
        _const__WEBPACK_IMPORTED_MODULE_6__["UpdateType"].MINOR,
        Object.assign(
            {},
            this._film,
            {
  ...
  _onCommentViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _const__WEBPACK_IMPORTED_MODULE_6__["UserAction"].DELETE_COMMENT:
        this._api.deleteComments(update)
      .then(() => {
        this._commentsModel.deleteComments(_const__WEBPACK_IMPORTED_MODULE_6__["UpdateType"].PATCH, update);
      });
  ...
  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._filmCardComponent);
  }
}
...
/* harmony import */ var _view_films_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/films-container */ "./src/view/films-container.js");
/* harmony import */ var _view_films_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/films-list */ "./src/view/films-list.js");
/* harmony import */ var _film__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./film */ "./src/presenter/film.js");
...
/* harmony import */ var _view_films_extra__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/films-extra */ "./src/view/films-extra.js");
/* harmony import */ var _view_no_films__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/no-films */ "./src/view/no-films.js");
/* harmony import */ var _view_loading_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/loading.js */ "./src/view/loading.js");
...
/* harmony import */ var _utils_sort__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/sort */ "./src/utils/sort.js");
...
class FilmList {
  constructor(container, filmsModel, filtersModel, api) {
    ...
    // components
    this._filmsListComponent = new _view_films_list__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._moreButtonComponent = new _view_show_more_button__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._noFilmsComponent = new _view_no_films__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._sortComponent = new _view_sort__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._filmsContainerComponent = new _view_films_container__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._loadingComponent = new _view_loading_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    ...
    this._currentfilter = _const__WEBPACK_IMPORTED_MODULE_10__["FilterType"].ALL_MOVIES;
  }
  ...
  _getFilms() {
    ...
    if (this._currentfilter !== filterType) {
      this._currentSortType = _const__WEBPACK_IMPORTED_MODULE_10__["SortType"].DEFAULT;
      this._sortComponent.activeSortType = _const__WEBPACK_IMPORTED_MODULE_10__["SortType"].DEFAULT;
      this._currentfilter = filterType;
    }
    const films = this._filmsModel.films;
    const filtredFilms = _utils_filter__WEBPACK_IMPORTED_MODULE_9__["filter"][filterType](films);

    switch (this._currentSortType) {
      case _const__WEBPACK_IMPORTED_MODULE_10__["SortType"].DATE:
        return filtredFilms.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_11__["sortFilmsByDate"]);
      case _const__WEBPACK_IMPORTED_MODULE_10__["SortType"].RATING:
        return filtredFilms.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_11__["sortFilmsByRating"]);
    }
    return filtredFilms;
  }

  _renderFilmsContainer() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._container, this._filmsContainerComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsContainerComponent, this._filmsListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderFilmsList() {
    ...
    this._renderFilmsExtraList(_const__WEBPACK_IMPORTED_MODULE_10__["ExstraFilmsList"].TOP_RATED);
    this._renderFilmsExtraList(_const__WEBPACK_IMPORTED_MODULE_10__["ExstraFilmsList"].MOST_COMMENTED);
  }

  _renderFilms() {
    const films = this._getFilms();
    for (const film of films.slice(this._NUM_RENDERED_CARDS, this._NUM_RENDERED_CARDS + this._NUM_RENDER_CARDS)) {
      const filmsPresenter = new _film__WEBPACK_IMPORTED_MODULE_3__["default"](this._filmsListComponent.filmsContainer, this._onViewAction, this._closePrevDetails);
    ...
    if (this._NUM_RENDERED_CARDS >= this._getFilms().length) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._moreButtonComponent);
    }
  }

  _renderFilmsExtraList(title) {
    const filmsExtraListComponent = new _view_films_extra__WEBPACK_IMPORTED_MODULE_5__["default"](title);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsContainerComponent, filmsExtraListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  }

  _renderNoFilms() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._container, this._noFilmsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  }

  _renderLoading() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._container, this._loadingComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderMoreButton() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsListComponent.getElement(), this._moreButtonComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderSort() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._container, this._sortComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  }
  ...
  _clearFilmsList() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._filmsListComponent);
  ...
  _onViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _const__WEBPACK_IMPORTED_MODULE_10__["UserAction"].UPDATE_FILM:
        this._api.updateFilm(update).then((response) => {
          this._filmsModel.updateFilm(updateType, response);
        });
        break;
      case _const__WEBPACK_IMPORTED_MODULE_10__["UserAction"].ADD_FILM:
        this._filmsModel.addFilm(updateType, update);
        break;
      case _const__WEBPACK_IMPORTED_MODULE_10__["UserAction"].DELETE_FILM:
...
class Filter {
  ...
  _getFilters() {
    ...
    return {
      allMovies: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL_MOVIES](films).length,
      watchlist: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCH_LIST](films).length,
      favorites: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES](films).length,
      history: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY](films).length
    };
  }
}
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: parseToMinAndHours, getRandomInteger */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseToMinAndHours", function() { return parseToMinAndHours; });
...
const parseToMinAndHours = (minutes) => {
  const durationInMin = dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.duration(minutes, `m`);
...
const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL_MOVIES]: (films) => films.filter((film) => film),
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCH_LIST]: (films) => films.filter((film) => film.isWatchlist)
};
...
/*!***************************!*\
  !*** ./src/utils/sort.js ***!
  \***************************/
/*! exports provided: sortFilmsByDate, sortFilmsByRating */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const sortFilmsByDate = (a, b) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(b.release.date).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(a.release.date));
...
class Comment extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    ...
    <div>
      ...
      <p class="film-details__comment-info">
        ...
        <span class="film-details__comment-day">${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`YYYY/MM/DD HH:MM`)}</span>
  ...
  _onRemoveComment(evt) {
    ...
    this._callback.removeComment(
        ...
        _const__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].DELETE_COMMENT,
        this._comment
    );
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CommentCount; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");



class CommentCount extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _view_smart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/smart */ "./src/view/smart.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_1__);
...
class Details extends _view_smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(film) {
    super();
          ...
          <div class="film-details__info">
            ...
            <table class="film-details__table">
              ...
              <tr class="film-details__row">
                ...
                <td class="film-details__cell">${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(release.date).format(`DD MMMM YYYY`)}</td>
              </tr>
              <tr class="film-details__row">
                <td class="film-details__term">Runtime</td>
                <td class="film-details__cell">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["parseToMinAndHours"])(runtime)}</td>
              </tr>
              <tr class="film-details__row">
        ...
        <section class="film-details__comments-wrap">
          ...
          <div class="film-details__new-comment">
            ...
            <label class="film-details__comment-label">
              <textarea class="film-details__comment-input" placeholder="Select reaction below and write comment here" name="comment">${he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(`Great movie!`)}</textarea>
            </label>
...
class FilmCard extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    ...
    <p class="film-card__info">
      <span class="film-card__year">${dayjs__WEBPACK_IMPORTED_MODULE_1___default()(release.date).format(`YYYY`)}</span>
      <span class="film-card__duration">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_2__["parseToMinAndHours"])(runtime)}</span>
...
class Filter extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _onfilterTypeChange(evt) {
    evt.preventDefault();
    if (evt.target.innerText.includes(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].WATCH_LIST)) {
      this._currentFilterType = _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].WATCH_LIST;
    } else if (evt.target.innerText.includes(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].HISTORY)) {
      this._currentFilterType = _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].HISTORY;
    } else if (evt.target.innerText.includes(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FAVORITES)) {
      this._currentFilterType = _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FAVORITES;
    } else {
      this._currentFilterType = _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL_MOVIES;
    }
    this._removeActiveFilter();
